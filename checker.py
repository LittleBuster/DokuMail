...
class Checker():
    ...
    def on_update_available(self):
        self.mainWnd.recieve.set_configs(self.mainWnd.TCPServer, self.mainWnd.TCPPort, self.mainWnd.user,
                                         self.mainWnd.passwd, True, self.mainWnd.cur_path)
        self.mainWnd.recieve.start()

    def on_files_available(self):
        self.mainWnd.recieve.set_configs(self.mainWnd.TCPServer, self.mainWnd.TCPPort, self.mainWnd.user,
                                         self.mainWnd.passwd, False, self.mainWnd.cur_path)
        self.mainWnd.recieve.start()
    ...
    def set_configs(self, configs, user):
        ...
        self.th_n.set_configs(configs, user, self.mainWnd.cur_path)
        self.del_news.set_configs(configs, self.mainWnd.cur_path)
